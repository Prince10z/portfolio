...
window.onload = function () {
    ...
    css.type = "text/css";
    css.innerHTML = ".typewrite > .wrap { background: none; border-right: 0.08em solid #fff}";
...
function animateIntroText() {
    ...
    const introbody = "I'm a seasoned software designer and developer with extensive experience in Flutter and MERN. Known for my adept problem-solving skills, I've successfully completed diverse projects, simplifying complexities. I'm enthusiastic about exploring new challenges and cutting-edge technologies to deliver impactful solutions that meet evolving needs.";
